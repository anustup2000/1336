...
%unit_cell_FCC.m
%Here we modify the original code and plot the atomic positions for the FCC crystal
%and then plot its conventional and primitive unit cells.
clc
close all
a=1.0; %lattice constant
%The BCC smallest possible translation vectors
a0=[0;0;0]; % atom at origin
a1=a*[0;1/2;1/2]; 
a2=a*[1/2;0;1/2]; 
a3=a*[1/2;1/2;0]; % a1,a2,a3 are positions of atoms at face centers surrounding the origin atom in the unit cell
a4=a1+a2; % i.e. a4=a*[1/2;1/2;1];
a5=a1+a3; % i.e. a5=a*[1/2;1;1/2];
a6=a2+a3; % i.e. a6=a*[1;1/2;1/2]; these atoms are in the face centers of the unit cell (next nearest neighbours atoms)
a7=a4+a3; % i.e. a7=a*[1;1;1]; corner cell of the unit cell
%primitive cell can be built now with 8 corner positions and also make some new ones for structure purposes
a8=a1-a2; % i.e. a8=a*[-1/2;1/2;0]; 
a9=a1-a3; % i.e. a9=a*[-1/2;0;1/2]; 
a10=a2-a3; % i.e. a10=a*[0;-1/2;1/2]; face centers in other unit cells
a11=a4-a3; % i.e. a11=a*[0;0;1]; corner atom
a12=2*a1; % i.e. a12=a*[0;1;1]; 
a13=2*a2; % i.e. a13=a*[1;0;1];
a14=2*a3; % i.e. a14=a*[1;1;0]; corner atoms in other unit cells
%First eight in T are to construct the primitive cell. Since the nearest
%neighbours to a corner atom are body centers, we take vectors halfway
%along that direction
T=[a0,a1,a2,a3,a4,a5,a6,a7,-a1,-a2,-a3,a8,a9,a10,a11]; 
T=[T,-a4,-a5,-a6,-a7,-a8,-a9,-a10,-a11,a12,a13,a14,-a12,-a13,-a14];
%We should identify the unit cell positions too
...
title("FCC, conventional cell (dashed black), primitive cell (thick blue)")